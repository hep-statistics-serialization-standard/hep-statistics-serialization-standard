...
A parameter of a distribution may refer to the output of a function via its
name.

A parameter of a distribution may also refer to (the variate of) another
distributions via its name. Note though that
distribution parameters will often be scalar or arrays while distribution
variates are always named tuples in this standard. So in practice, one will
often use a function like `get_property` in between.


```json title="Example: Data distribution"
"distributions":[
	{ 
		"name": "gauss1", 
		"type": "gaussian_dist", 
...
```json title="Example: Prior distribution"
"distributions":[
	{ 
		"name": "avg_bl_dist", 
		"type": "gaussian_dist", 
		"mean": 0.0, 
		"sigma": 3.0, 
		"x": "average_baseline_level" 
	}, 
	{ 
		"name": "bl_var_dist", 
		"type": "exponential_dist", 
		"x": "baseline_variation", 
		"c": 1.5 
	},
	{ 
		"name": "bl1_dist", 
		"type": "gaussian_dist", 
		"mean": "average_baseline_level", 
	...
	{ 
		"name": "prior", 
		"type": "product_dist", 
		"factors": ["avg_bl_dist", "bl_var_dist", "bl1_dist", "bl2_dist", "bl3_dist"]
	},
	...
],
"functions": [ 
	{ 
		"name" : "average_baseline_level", 
		"type" : "get_property", 
		"from" : "avg_bl_dist", 
		"select" : "average_baseline_level" 
	},
	{ 
		"name" : "baseline_variation", 
		"type" : "get_property", 
		"from" : "bl_var_dist", 
		"select" : "baseline_variation" 
	},
	... 
]
```

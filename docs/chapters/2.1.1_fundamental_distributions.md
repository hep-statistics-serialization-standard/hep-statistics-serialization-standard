...
The generalised normal distribution is defined as

$$
\begin{aligned} \text{GenNormalPdf}(x; \mu, \sigma, \beta) = \frac{1}{\ensuremath{\mathcal{M}}} \exp\left\{ -\left( \frac{|x-\mu|}{\alpha} \right)^\beta \right\} \begin{aligned}
$$

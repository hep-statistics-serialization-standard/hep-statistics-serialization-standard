...
This function is similar the the Poisson distribution (see [Poisson
...
-   `x`: a name for the array variate `\mathbf{x}` or an array of names for the scalar variates $x_i$. This also includes mixed arrays of values and names. 
